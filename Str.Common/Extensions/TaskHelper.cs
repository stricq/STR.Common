...
public static class TaskHelper {
    ...
    private static readonly ArgumentNullException SchedulerNotInitializedException = new(nameof(uiScheduler), "The UI TaskScheduler is not initialized.  Please call InitializeOnUiThread before use.");
