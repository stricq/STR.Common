...
public static class StreamExtensions {
    ...
    public static async Task CopyToAsync<T>(this Stream input, Stream output, int bufferSize = DefaultBufferSize, FileDownloadProgressMessage<T>? message = null, Action<FileDownloadProgressMessage<T>?>? callback = null) where T : class {
        await input.CopyToAsync(output, bufferSize, message as FileDownloadProgressMessage, callback as Action<FileDownloadProgressMessage?>).Fire();
    }
